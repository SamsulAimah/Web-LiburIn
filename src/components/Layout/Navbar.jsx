        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            <input
              type="text"
              placeholder="Search..."
              className="border border-gray-300 rounded-full py-1.5 pl-12 pr-16 text-sm focus:ring-2 focus:ring-orange-400 focus:outline-none"
            />
            <Search
              size={18}
          ...
          <Link
            to="/login"
            className="bg-orange-500 font-bold text-white px-5 py-1.5 rounded-full text-sm hover:bg-orange-600 transition flex items-center gap-2"
          >
             Login
            <svg
              xmlns="http://www.w3.org/2000/svg"
